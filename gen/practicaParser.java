...
public class practicaParser extends Parser {
	...
	public static class AxiomaContext extends ParserRuleContext {
		public List<TerminalNode> IDENT() { return getTokens(practicaParser.IDENT); }
		public TerminalNode IDENT(int i) {
			return getToken(practicaParser.IDENT, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof practicaListener ) ((practicaListener)listener).enterAxioma(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof practicaListener ) ((practicaListener)listener).exitAxioma(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof practicaVisitor ) return ((practicaVisitor<? extends T>)visitor).visitAxioma(this);
